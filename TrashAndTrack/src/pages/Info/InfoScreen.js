...
const infoSections = [
  {
    ...
    content: 'Como recolector de residuos peligrosos industriales, es clave conocer el marco legal que regula tus operaciones y responsabilidades.',
    subItems: [
      {
        id: 'lgpgir',
    ...
    <View style={styles.accordionContainer}>
      <TouchableOpacity onPress={toggleExpand} style={styles.accordionHeader}>
        <View style={styles.headerContent}>
          {icon && <Ionicons name={icon} size={24} color="#4682B4" style={styles.headerIcon} />}
